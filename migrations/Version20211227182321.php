 ...
 */
final class Version20211227182321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE auteur (id INT AUTO_INCREMENT NOT NULL, nom_prenom VARCHAR(100) NOT NULL, sexe VARCHAR(1) NOT NULL, date_de_naissance DATE NOT NULL, nationalite VARCHAR(150) NOT NULL, UNIQUE INDEX UNIQ_55AB14026EA0B0C (nom_prenom), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, isbn VARCHAR(17) NOT NULL, titre VARCHAR(150) NOT NULL, nombre_pages INT NOT NULL, date_de_parution DATE NOT NULL, note DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
